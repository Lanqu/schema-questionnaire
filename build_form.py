...
<h2 style="cursor:pointer" onclick="toggleHint('ysq-method-desc')">Young Schema Questionnaire (YSQ-S3R) <span style="font-size:13px;color:#888;font-weight:400">&#9432; о методике</span></h2>
...
<h2 style="cursor:pointer" onclick="toggleHint('smi-method-desc')">Schema Mode Inventory (SMI v1.1) <span style="font-size:13px;color:#888;font-weight:400">&#9432; о методике</span></h2>
